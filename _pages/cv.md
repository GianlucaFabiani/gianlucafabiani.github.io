...
Gianluca Fabiani has served as a reviewer for several scientific journals (18), covering topics related to scientific computing, dynamical systems, and multidisciplinary research. His peer review contributions include the following **(total 50 reviews)**:
...
* _Soft Computing (Elsevier)_ **14** <!-- Q2 --> <!-- 21 -->
* _Nonlinear Dynamics (Springer)_ **5** <!-- Q1 --> <!-- 15 -->
* _Plos One_ **5** <!-- Q1low --> <!-- 10 -->
* _Scientific Reports (Springer)_ **4** <!-- Q1low --> <!-- 8 -->
...
* _Mathematics (mdpi)_ **3** <!-- Q2 --> <!-- 4.5 -->
* _Transaction on machine learning research_ **2** <!-- Q1high (secondary venue) --> <!-- 4 -->
* _Artificial Intelligence Review (Springer)_ **1** <!-- Q1high --> <!-- 4 -->
...
* _International Journal of Applied and Computational Mathematics (Springer)_ **1** <!-- Q3 --> <!-- 0.75 -->
