...
Gianluca Fabiani has served as a reviewer for several scientific journals (**22**), covering topics related to scientific computing, numerical analysis, machine learning, dynamical systems, and multidisciplinary research. His peer review contributions include the following **(total 68 reviews)**:
...
* _Soft Computing (Elsevier)_ **20** <!-- Q2 --> <!-- 30 (soco)--> 
