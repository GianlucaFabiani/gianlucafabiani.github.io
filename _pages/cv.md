...
Gianluca Fabiani has served as a reviewer for several scientific journals (**22**), covering topics related to scientific computing, numerical analysis, machine learning, dynamical systems, and multidisciplinary research. His peer review contributions include the following **(total 66 reviews)**:
...
* _Soft Computing (Elsevier)_ **19** <!-- Q2 --> <!-- 28.5 (soco)--> 
* _Nonlinear Dynamics (Springer)_ **6** <!-- Q1 --> <!-- 18 -->
* _Plos One_ **6** <!-- Q1low --> <!-- 12 -->
* _Scientific Reports (Nature Portfolio)_ **5** <!-- Q1low --> <!-- 10 -->
...
* _Transaction on machine learning research_ **3** <!-- Q1high (secondary venue, so Q1low) --> <!-- 6 -->
